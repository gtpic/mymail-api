      ...
      <div class="scroll-body">
        <div class="card-grid">
          ...
          <div class="settings-card">
            ...
            <div class="card-content">
			  <div class="setting-item">
                <div class="title-item"><span>{{ $t('displayTimezone') }}</span></div>
                <div>
                  <el-select @change="change" v-model="setting.timezone" placeholder="请选择" style="width: 140px;" size="small">
                    <el-option label="UTC-11 (萨摩亚)" :value="-11" />
                    <el-option label="UTC-10 (夏威夷)" :value="-10" />
                    <el-option label="UTC-9 (阿拉斯加)" :value="-9" />
                    <el-option label="UTC-8 (太平洋时间)" :value="-8" />
                    <el-option label="UTC-7 (美国山区)" :value="-7" />
                    <el-option label="UTC-6 (美国中部)" :value="-6" />
                    <el-option label="UTC-5 (美东时间)" :value="-5" />
                    <el-option label="UTC-4 (大西洋)" :value="-4" />
                    <el-option label="UTC-3 (巴西利亚)" :value="-3" />
                    <el-option label="UTC-2 (中大西洋)" :value="-2" />
                    <el-option label="UTC-1 (亚速尔)" :value="-1" />
                    <el-option label="UTC+0 (格林威治)" :value="0" />
                    <el-option label="UTC+1 (中欧时间)" :value="1" />
                    <el-option label="UTC+2 (东欧时间)" :value="2" />
                    <el-option label="UTC+3 (莫斯科)" :value="3" />
                    <el-option label="UTC+4 (阿布扎比)" :value="4" />
                    <el-option label="UTC+5 (伊斯兰堡)" :value="5" />
                    <el-option label="UTC+6 (达卡)" :value="6" />
                    <el-option label="UTC+7 (曼谷/雅加达)" :value="7" />
                    <el-option label="UTC+8 (北京/上海)" :value="8" />
                    <el-option label="UTC+9 (东京/首尔)" :value="9" />
                    <el-option label="UTC+10 (悉尼/关岛)" :value="10" />
                    <el-option label="UTC+11 (所罗门)" :value="11" />
                    <el-option label="UTC+12 (惠灵顿)" :value="12" />
                  </el-select>
                </div>
              </div>
              <div class="setting-item">
